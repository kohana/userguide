...
<div class="toc">
	<div class="constants">
		<h3><?php echo __('Constants', NULL, 'en-us'); ?></h3>
		<ul>
		...
		<?php endforeach ?>
		<?php else: ?>
			<li><em><?php echo __('None', NULL, 'en-us'); ?></em></li>
		<?php endif ?>
		</ul>
	</div>
	<div class="properties">
		<h3><?php echo __('Properties', NULL, 'en-us'); ?></h3>
		<ul>
	...
	<div class="methods">
		<h3><?php echo __('Methods', NULL, 'en-us'); ?></h3>
		<ul>
...
<?php if ($doc->constants): ?>
<div class="constants">
<h1 id="constants"><?php echo __('Constants', NULL, 'en-us'); ?></h1>
<dl>
<?php foreach ($doc->constants as $name => $value): ?>
...
<?php if ($properties = $doc->properties()): ?>
<h1 id="properties"><?php echo __('Properties', NULL, 'en-us'); ?></h1>
<div class="properties">
<dl>
<?php foreach ($properties as $prop): ?>
...
<?php if ($methods = $doc->methods()): ?>
<h1 id="methods"><?php echo __('Methods', NULL, 'en-us'); ?></h1>
<div class="methods">
<?php foreach ($methods as $method): ?>
