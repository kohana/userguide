...
class Controller_Userguide extends Controller_Template {
	...
	public function action_docs()
	{
		...
		{
			return $this->error(__('That module doesn\'t exist, or has userguide pages disabled.', NULL, 'en-us'));
		}
		
		// Prevent "guide/module" and "guide/module/index" from having duplicate content
		if ( $page == 'index')
		{
			return $this->error(__('Userguide page not found', NULL, 'en-us'));
		}
		...
		$breadcrumb = array();
		$breadcrumb[$this->guide->uri()] = __('User Guide', NULL, 'en-us');
	...
	public function action_api()
	{
		...
		if ( ! $class)
		{
			$this->template->title = __('Table of Contents', NULL, 'en-us');
		...
		// Add the breadcrumb
		$breadcrumb = array();
		$breadcrumb[$this->guide->uri(array('page' => NULL))] = __('User Guide', NULL, 'en-us');
